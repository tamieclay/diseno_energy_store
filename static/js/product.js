  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", function (e) {
      if (e.target.classList.contains(`${imgName}__btnlft-img`)) {
        ...
        img.src = `imapro/image-product-${nextImg + 1}.jpg`;
      }
...
function closeMenu() {
  ...
  menuBtnImg.src = "imapro/icon-menu.svg";
}
...
overlayImgBtn.forEach((btn, i) => {
  btn.addEventListener("click", function (e) {
    overlayImg.src = `imapro/image-product-${i + 1}.jpg`;
...
imgBtn.forEach((btn, i) => {
  btn.addEventListener("click", function () {
    img.src = `imapro/image-product-${i + 1}.jpg`;
  });
});
